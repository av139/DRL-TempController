# test_model.py
# This script is used to test a pre-trained model
...
# Adjust the action space type to ensure compatibility
...
# Evaluate the model using the environment
...
def main():
    ...
    try:
        ...
        env = Monitor(env)  # Wrap the environment for evaluation
        env = DummyVecEnv([lambda: env])
        model = load_model(args.model_path, args.algorithm)
        
        # Update the log directory to include the action space type
